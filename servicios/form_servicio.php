...
<body>
    ...
    <div class="users-form">
        <br><h2>Ingresar servicio</h2>
        <form action="insert_servicio.php" method="POST">
            <input type="text" name="nombre_servicio" placeholder="Nombre">
            <input type="text" name="tipo_tarifa" placeholder="Tipo">
            <input type="text" name="monto_tarifa" placeholder="Tarifa">
