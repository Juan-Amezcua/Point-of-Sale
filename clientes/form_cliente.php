...
<body>
    ...
    <div class="users-form">
        ...
        <form action="insert_cliente.php" method="POST">
            ...
            <input type="text" name="correo_cliente" placeholder="Correo">
            <input type="text" name="id_colaborador_fk" placeholder="Colaborador que registra">
